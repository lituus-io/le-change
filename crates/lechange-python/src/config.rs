...
impl PyConfig {
    ...
    #[pyo3(signature = (
        ...
        use_rest_api=None,
        detect_vanished=None,
        vanished_max_commits=None,
        deleted_to_destroy=None,
        api_url=None,
        token=None,
    ...
    fn new(
        ...
        detect_vanished: Option<bool>,
        vanished_max_commits: Option<u32>,
        deleted_to_destroy: Option<bool>,
        ...
        Self {
            ...
            detect_vanished: detect_vanished.unwrap_or(false),
            vanished_max_commits: vanished_max_commits.unwrap_or(500),
            deleted_to_destroy: deleted_to_destroy.unwrap_or(false),
            api_url,
            token,
...
impl PyConfig {
    ...
    pub fn to_core_config(&self) -> lechange_core::InputConfig<'_> {
        lechange_core::InputConfig {
            ...
            detect_vanished: self.detect_vanished,
            vanished_max_commits: self.vanished_max_commits,
            deleted_to_destroy: self.deleted_to_destroy,
