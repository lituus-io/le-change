...
use lechange_core::types::{ProcessedResult, RebuildReasonKind};
use pyo3::prelude::*;
...
impl PyChangedFiles {
    ...
    fn __repr__(&self) -> String {
        format!(
            "ChangedFiles(total={}, added={}, modified={}, deleted={}, rebuild={}, skip={})",
            self.all_changed_files.len(),
            self.added_files.len(),
            self.modified_files.len(),
            self.deleted_files.len(),
...
impl PyChangedFiles {
    ...
    pub fn from_core(
        ...
        Self {
            ...
            modified_keys: outputs.modified_keys.clone(),
            changed_keys: outputs.changed_keys.clone(),
            files_to_rebuild,
            files_to_skip,
            failed_jobs,
            successful_jobs,
